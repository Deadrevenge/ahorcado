...
mensajeVidas.style.display = "none";
...
function hideBotonIniciar() {
  ...
  mensajeVidas.style.display = "block";
...
// Función para actualizar el mensaje de vidas
function actualizarMensajeVidas() {
  mensajeVidas.textContent = "Selecciona una letra para encontrar la palabra, tienes " + (6 - vidas) + " intentos.";
}
